...
## ソースコードの説明
標本を標準化することで、標準正規分布に従うので、p=stdnormで出現確率を求める。
尤度はREADMEより掛けていけばよい。
...
[comment #20200430]
- 課題２完了．
- ちなみに，A県の尤度がB県の尤度より高いということは，今回の標本はA県から取られた「らしさ」が高いということですが，尤度が最大となる平均と分散は何だと思いますか？それは課題１で求めた母集団平均（推定値）と母集団分散（推定値）です．逆に言うと，課題１の最良推定の「最良」とは尤度が最大という意味で「最良」としています（最尤推定，最少二乗推定）．最尤推定の他にも「最良」の基準がありますが，それは統計や機械学習の授業で学んでください．
